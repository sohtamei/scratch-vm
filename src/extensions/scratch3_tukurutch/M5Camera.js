...
setBatteryConnect(args,util) { return this.sendRecv('setBatteryConnect', args); }
getBatteryVoltage(args,util) { return this.sendRecv('getBatteryVoltage', args); }
