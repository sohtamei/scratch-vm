...
*/
	...
	get_blocks() {
		this.flashList = [
{name:'micomLCD.esp32', type:'esp32', baudrate:921600},
{name:'micomLCD.esp32_750000', type:'esp32', baudrate:750000},
		];
...
{blockType: BlockType.REPORTER, opcode: 'getLcdConfig', text: 'get config', arguments: {
}},
...
getLcdConfig(args,util) { return this.sendRecv('getLcdConfig', args); }
