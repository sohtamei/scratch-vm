...
{blockType: BlockType.COMMAND, opcode: 'initLCD', text: 'initLCD i2c=[ARG1] [ARG2] type=[ARG3]', arguments: {
    ARG1: { type: ArgumentType.NUMBER, type2:'B', defaultValue:21 },
    ARG2: { type: ArgumentType.NUMBER, type2:'B', defaultValue:22 },
    ARG3: { type: ArgumentType.STRING, type2:'B', defaultValue:'0', menu: 'lcdType' },
}},
...
{blockType: BlockType.COMMAND, opcode: 'setText', text: 'set text [ARG1] ,[ARG2] size=[ARG3]', arguments: {
    ...
    ARG3: { type: ArgumentType.NUMBER, type2:'B', defaultValue:2 },
}},
...
{blockType: BlockType.COMMAND, opcode: 'drawStage2', text: 'draw stage=([ARG1],[ARG2]) - ([ARG3],[ARG4]) rotete=[ARG5] lcd=[ARG6]x[ARG7]', arguments: {
    ...
    ARG6: { type: ArgumentType.NUMBER, defaultValue:128 },
    ARG7: { type: ArgumentType.NUMBER, defaultValue:64 },
}},
		];
		this.blockOffset = 6;
