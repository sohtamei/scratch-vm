...
*/
	...
	get_blocks() {
		this.flashList = [
{name:'SSD1306.esp32', type:'esp32', baudrate:921600},
		];
...
{blockType: BlockType.COMMAND, opcode: 'initLCD', text: 'initLCD i2c=[ARG1] [ARG2] size=[ARG3] x [ARG4]', arguments: {
    ARG1: { type: ArgumentType.NUMBER, type2:'B', defaultValue:21 },
    ARG2: { type: ArgumentType.NUMBER, type2:'B', defaultValue:22 },
    ARG3: { type: ArgumentType.NUMBER, type2:'S', defaultValue:128 },
    ARG4: { type: ArgumentType.NUMBER, type2:'S', defaultValue:64 },
}},

{blockType: BlockType.COMMAND, opcode: 'setFont', text: 'set font=[ARG1]', arguments: {
    ARG1: { type: ArgumentType.STRING, type2:'B', defaultValue:'6', menu: 'font' },
}},

{blockType: BlockType.COMMAND, opcode: 'setText', text: 'set text size=[ARG1]', arguments: {
...
{blockType: BlockType.COMMAND, opcode: 'drawString', text: 'draw text [ARG1] ([ARG2] ,[ARG3] )', arguments: {
    ARG1: { type: ArgumentType.STRING, type2:'s', defaultValue:'テスト' },
    ARG2: { type: ArgumentType.NUMBER, type2:'S', defaultValue:0 },
    ARG3: { type: ArgumentType.NUMBER, type2:'S', defaultValue:0 },
}},

{blockType: BlockType.COMMAND, opcode: 'drawString2', text: 'draw text [ARG1] ([ARG2] ,[ARG3] ) font=[ARG4]', arguments: {
    ARG1: { type: ArgumentType.STRING, type2:'s', defaultValue:'test' },
    ARG2: { type: ArgumentType.NUMBER, type2:'S', defaultValue:0 },
    ARG3: { type: ArgumentType.NUMBER, type2:'S', defaultValue:0 },
    ARG4: { type: ArgumentType.STRING, type2:'B', defaultValue:'1', menu: 'font' },
}},

{blockType: BlockType.COMMAND, opcode: 'fillScreen', text: 'fill screen with BLACK', arguments: {
}},

{blockType: BlockType.COMMAND, opcode: 'drawJpg', text: 'draw jpg [ARG1]', arguments: {
    ARG1: { type: ArgumentType.STRING, type2:'b2', defaultValue:'' },
}},
...
{ text: 'ascii8', value: '0' },
{ text: 'ascii16', value: '1' },
{ text: 'ascii26', value: '2' },
{ text: 'num48', value: '3' },
{ text: '7seg48', value: '4' },
{ text: 'num75', value: '5' },
{ text: 'monospace12', value: '6' },
{ text: 'monospace16', value: '7' },
{ text: 'proportional12', value: '8' },
{ text: 'proportional16', value: '9' },
]},
...
initLCD(args,util) { return this.sendRecv('initLCD', args); }
