...
{blockType: BlockType.COMMAND, opcode: 'setBeep', text: 'beep [ARG1]', arguments: {
...
sw: { acceptReporters: true, items: ['1','2','3','4',]},
...
setBeep(args,util) { return this.sendRecv('setBeep', args); }
