...
oledSetCursor(args,util) { return this.sendRecv('oledSetCursor', args); }
oledPrint(args,util) { return this.sendRecv('oledPrint', args); }
oledPrintLine(args,util) { return this.sendRecv('oledPrintLine', args); }
oledClear(args,util) { return this.sendRecv('oledClear', args); }
getDhtTemp(args,util) { return this.sendRecv('getDhtTemp', args); }
getDhtHum(args,util) { return this.sendRecv('getDhtHum', args); }
getBmpTemp(args,util) { return this.sendRecv('getBmpTemp', args); }
getBmpPress(args,util) { return this.sendRecv('getBmpPress', args); }
getAccel(args,util) { return this.sendRecv('getAccel', args); }
