...
/**
 * Class for the M5Series block in Scratch 3.0.
 * @constructor
 */
class Scratch3M5SeriesBlocks {
    constructor (runtime) {
        /**
		...
		for(let i=0;i<cookies_get.length;i++) {
			...
			if(tmp[0]=='M5Series_ip') {
				this._ipadrs=tmp[1];
				console.log('M5Series_ip='+this._ipadrs);
				break;
			}
		}
    }
...
module.exports = Scratch3M5SeriesBlocks;
