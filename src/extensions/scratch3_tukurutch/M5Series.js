...
drawJpg(args,util) { return this.sendRecv('drawJpg', args); }
	...
	drawStage(args,util) {
		this.comlib._runtime.renderer.setDevSize(320,240);
		...
		args.ARG1 = Base64Util.base64ToUint8Array(tmpData.base64);
	...
	drawStage2(args,util) {
		this.comlib._runtime.renderer.setDevSize(Number(args.ARG6),Number(args.ARG7));
		...
		const tmpData = this.comlib._runtime.renderer.drawWithMask(maskSkinId,
								...
								Number(args.ARG5));
		if(typeof tmpData === 'undefined') return;
		const args2 = {ARG1:Base64Util.base64ToUint8Array(tmpData.base64)}
