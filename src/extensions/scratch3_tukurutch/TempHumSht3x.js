...
//var ext = class {
	...
	getInfo() {
		...
		return {
			...
			blocks: [
				{blockType: BlockType.COMMAND, opcode: 'setAdrs', text: 'I2C address [ARG1]', arguments: {
					ARG1: { type: ArgumentType.STRING, defaultValue:"21_22", menu: 'i2cAdrs' },
				}},
			...
			menus: {
				...
				{ text: 'd20 c19 micro:bit', value: '20_19', },
				{ text: 'd0 c1 micro:bit', value: '0_1', },
				]},
			},
		};
	}

	setAdrs(args, util, blockInfo) {
		this.adrs = args.ARG1.split('_');
	}

	getTemp(args, util, blockInfo) {
		const _this = this;
		return this.runtime.dev.comlib.wire_begin(this.adrs[0], this.adrs[1])
