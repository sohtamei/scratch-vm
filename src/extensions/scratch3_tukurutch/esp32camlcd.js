...
{blockType: BlockType.COMMAND, opcode: 'setMotor', text: 'set motor [ARG1] speed [ARG2]', arguments: {
    ARG1: { type: ArgumentType.STRING, type2:'B', defaultValue:'0', menu: 'motorch' },
    ARG2: { type: ArgumentType.NUMBER, type2:'S', defaultValue:100 },
}},
...
{blockType: BlockType.COMMAND, opcode: 'setPwmFreq', text: 'set pwm freq [ARG1] bits [ARG2]', arguments: {
    ARG1: { type: ArgumentType.NUMBER, type2:'S', defaultValue:50 },
    ARG2: { type: ArgumentType.NUMBER, type2:'B', defaultValue:12 },
}},
