...
/**
 * Class for the Duke32AIO block in Scratch 3.0.
 * @constructor
 */
class Scratch3Duke32AIOBlocks {
    constructor (runtime) {
        /**
...
getAnalog(args,util) { return this.getTest(arguments.callee.name, args); }
    ...
    setIotIp (args) {
        ...
        document.cookie = 'Duke32AIO_ip=' + this._ipadrs + '; samesite=lax;';
        if(SupportCamera) {
...
module.exports = Scratch3Duke32AIOBlocks;
