...
*/
	...
	get_blocks() {
		this.flashList = [
{name:'DevkitC_ESP32', type:'esp32', baudrate:921600},
{name:'DevkitC_S3.uart', type:'esp32s3', baudrate:921600},
{name:'generic_ESP32.921600', type:'esp32', baudrate:921600},
{name:'generic_ESP32.115200', type:'esp32', baudrate:115200},
		];
...
'---',
{blockType: BlockType.COMMAND, opcode: 'showLED', text: [
    'show onboard led red [ARG1] green [ARG2] blue [ARG3]',
    'オンボードLEDを点灯 赤 [ARG1] 緑 [ARG2] 青 [ARG3]',
][this._locale], arguments: {
    ARG1: { type: ArgumentType.NUMBER, type2:'S', defaultValue:255 },
    ARG2: { type: ArgumentType.NUMBER, type2:'S', defaultValue:255 },
    ARG3: { type: ArgumentType.NUMBER, type2:'S', defaultValue:255 },
}},
