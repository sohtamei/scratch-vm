...
*/
	...
	get_blocks() {
		this.flashList = [
{name:'M5Unified.esp32', type:'esp32', baudrate:921600},
{name:'M5Unified.esp32.750000', type:'esp32', baudrate:750000},
{name:'M5Unified.esp32s3', type:'esp32s3u', baudrate:921600},
		];
...
{blockType: BlockType.COMMAND, opcode: 'drawJpg', text: '［LCD］draw jpg [ARG1]', arguments: {
...
{blockType: BlockType.COMMAND, opcode: 'setBrightness', text: '［LCD］set brightness [ARG1]', arguments: {
    ARG1: { type: ArgumentType.NUMBER, type2:'B', defaultValue:128 },
}},
