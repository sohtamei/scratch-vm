...
*/
	...
	getInfo() {
		...
		return {
			...
			blocks: [
				{blockType: BlockType.REPORTER, opcode: 'sht30Temp', text: '［SHT30］'+['temperature','温度'][this._locale], arguments: {
				}},

				{blockType: BlockType.REPORTER, opcode: 'sht30Humidity', text: '［SHT30］'+['humidity','湿度'][this._locale], arguments: {
				}},

				{blockType: BlockType.COMMAND, opcode: 'bmp280Init', text: '［BMP280］'+['init adrs','初期化 アドレス'][this._locale]+'[ARG1]', arguments: {
					ARG1: { type: ArgumentType.STRING, defaultValue:'76', menu: 'adrs' },
				}},

				{blockType: BlockType.REPORTER, opcode: 'bmp280Temp', text: '［BMP280］'+['temperature［C］','温度［C］'][this._locale], arguments: {
				}},

				{blockType: BlockType.REPORTER, opcode: 'bmp280Pressure', text: '［BMP280］'+['pressure［Pa］','気圧［Pa］'][this._locale], arguments: {
				}},
	...
	bmp280Pressure(args)
	{
		...
		// Call bmp280Temp to get this.t_fine
		return this.bmp280Temp()
