		...
		return {
			...
			{blockType: BlockType.COMMAND, opcode: 'initLCD', text: 'init [ARG1] I2C=[ARG2] brightness[ARG3]', arguments: {
				...
				{blockType: BlockType.COMMAND, opcode: 'fillScreen', text: 'fill screen with [ARG1]', arguments: {
					ARG1: { type: ArgumentType.STRING, defaultValue:TFT_BLACK, menu: 'color' },
				}},
			...
			menus: {
				...
				color: { acceptReporters: true, items: [
					{ text: 'BLACK', value: TFT_BLACK },
					{ text: 'NAVY', value: TFT_NAVY },
					{ text: 'DARKGREEN', value: TFT_DARKGREEN },
					{ text: 'DARKCYAN', value: TFT_DARKCYAN },
					{ text: 'MAROON', value: TFT_MAROON },
					{ text: 'PURPLE', value: TFT_PURPLE },
					{ text: 'OLIVE', value: TFT_OLIVE },
					{ text: 'LIGHTGREY', value: TFT_LIGHTGREY },
					{ text: 'DARKGREY', value: TFT_DARKGREY },
					{ text: 'BLUE', value: TFT_BLUE },
					{ text: 'GREEN', value: TFT_GREEN },
					{ text: 'CYAN', value: TFT_CYAN },
					{ text: 'RED', value: TFT_RED },
					{ text: 'MAGENTA', value: TFT_MAGENTA },
					{ text: 'YELLOW', value: TFT_YELLOW },
					{ text: 'WHITE', value: TFT_WHITE },
					{ text: 'ORANGE', value: TFT_ORANGE },
					{ text: 'GREENYELLOW', value: TFT_GREENYELLOW },
					{ text: 'PINK', value: TFT_PINK },
					{ text: 'TRANSPARENT', value: TFT_TRANSPARENT },
				]},
