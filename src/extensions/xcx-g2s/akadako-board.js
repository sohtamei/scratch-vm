...
const bindTransport = require('firmata-io');
const SerialPort = require('@serialport/stream');
const WSABinding = require('./web-serial-binding');
const MidiDakoTransport = require('./mididako-transport');
const {getSettings} = require('./akadako-board-settings');
const {
    FIRMATA_7BIT_MASK,
    COLOR_ORDER,
    PIXEL_COMMAND,
