...
const MeshScratchLink = require('./meshScratchLink.js');
...
/**
 * Scratch 3.0 blocks to interact with a MeshScratchLink peripheral.
 */
class MeshMotion {
	...
	constructor (runtime) {
		var _that = this;
		var notifyCB = function (buf) {
			if(buf[0] == 0x1 && buf[1] == 0x3) {
				_that._MotionDetect = buf[2];  // 01 右, 02 下, 03 表, 04 裏, 05 上, 06 左
				console.log("MotionDetect "+_that._MotionDetect);
			}
		}

		this.runtime = runtime;
		this._peripheral = new MeshScratchLink(this.runtime, MeshMotion.EXTENSION_ID, 'MESH-100AC', notifyCB);
